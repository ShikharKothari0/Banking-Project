...
<html>
    <head>
        ...
        <title>Transaction History JSP Page</title>
    </head>
    <body>
        <center>
            <div class="row">
                <div class="container-fluid" style="background:teal; color:white; height:140px">
                    <hr><h1>TRANSACTION HISTORY JSP PAGE</h1><hr><br>
                </div>
                <div class="container-fluid" style="background:teal; color:white; height:486px">
                    <form>
                        <table cellpadding="5px">
                            ...
                            <tr><td></td></tr>
                            <tr>
                                <td>&emsp;&emsp;<button class="btn btn-outline-light" type="submit" name="Submit">View Transaction History</button></td>
            ...
            if(request.getParameter("Submit")!=null)
            {
                try
                {
                    ...
                    if(acno!=""&&pin!="")
                    {
                        ...
                        if(rs.next())
                        {
                            ResultSet rs1=stmt.executeQuery("select * from trnsc where Acno='"+acno+"'");
                            %>
                            <br><br>
                            ...
                            %>
                                <tr>
                                    <td><%=rs1.getString("trnsid")%></td>
                                    <td><%=rs1.getString("Acno")%></td>
                                    <td><%=rs1.getString("Amount")%></td>
                                    <td><%=rs1.getString("Time")%></td>
                                    <td><%=rs1.getString("Descp")%></td>
                                </tr>
                            <%
                                }
                            %>
